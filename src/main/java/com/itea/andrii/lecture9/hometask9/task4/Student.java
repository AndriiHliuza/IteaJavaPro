...
public class Student {
    ...
    private final int id; // Номер студента
    private final int yearOfEntry; // Рік вступу студента
    private final String name; // Ім'я студента
    private final String surname; // Прізвище студента
    private LocalDate birthday; // Дата народження студента
    private String email; // Email студента
    private final String university; // Університет в який поступив студент
    private final String faculty; // Факультет на який поступив студент
    private final String specialization; // Спеціалізація студента
