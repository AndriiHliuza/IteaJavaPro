package com.itea.andrii.lecture18.hometask18.task5;
...
public class Main {
    public static void main(String[] args) {
        Map<String, Object> students = readFile("src/main/java/com/itea/andrii/lecture18/hometask18/task5/students.json");
        ...
        writeFile("src/main/java/com/itea/andrii/lecture18/hometask18/task5/students.json", jsonObject.toString());
    }
